      ...
      <div className="w-full max-w-sm">
        ...
        <div className="glass border border-white/[0.08] rounded-2xl p-7 space-y-4">
          <button onClick={handleGoogle}
            className="w-full flex items-center justify-center gap-3 glass border border-white/[0.12] hover:border-white/25 py-3 rounded-xl text-sm font-bold transition-all">
